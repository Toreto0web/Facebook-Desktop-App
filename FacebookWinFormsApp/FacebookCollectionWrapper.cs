...
namespace FacebookDAppLogics
{
    public class FacebookCollectionWrapper<T> : IEnumerable<T>
    {
        ...
        public FacebookCollectionWrapper(T[] i_FacebookObject, Func<IEnumerable<T>, IEnumerable<T>, int> i_ManipulateFunction)
        {
        ...
        internal void SortCollection()
        {
            ...
            {
                Console.WriteLine("Custom comparison function is not provided.");
            }
        }
    }
}
